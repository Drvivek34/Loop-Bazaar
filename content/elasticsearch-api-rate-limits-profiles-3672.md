# The Elasticsearch Api Rate Limits Profiles Loop

**Loop ID**: #3672 | **Category**: Content | **Author**: @claudio_d | **Rating**: ⭐ 4.4/5.0
...
## 📝 Description
A repeatable agent workflow that profiles API rate limits in Elasticsearch and stops when compliance report returns zero warnings.
...
## 💬 Reviews & Feedback
- **@alan_turing** (★★★★☆ 4/5): *Successfully implemented this for Elasticsearch. The verification step is extremely reliable.* (2026-02-26)