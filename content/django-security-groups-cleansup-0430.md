# The Django Security Groups Cleans up Loop

**Loop ID**: #0430 | **Category**: Content | **Author**: @linus_t | **Rating**: ⭐ 4.8/5.0
...
## 📝 Description
A repeatable agent workflow that cleans up security groups in Django and stops when API response time is under 100ms.
...
## 💬 Reviews & Feedback
- **@ranvier2d2** (★★★★☆ 4/5): *Successfully implemented this for Django. The verification step is extremely reliable.* (2026-05-14)