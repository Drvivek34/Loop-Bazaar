# The MongoDB Git Hooks Configuration Audits Loop

**Loop ID**: #4600 | **Category**: Content | **Author**: @ada_lovelace | **Rating**: ⭐ 4.6/5.0
...
## 📝 Description
A repeatable agent workflow that audits Git hooks configuration in MongoDB and stops when error rate drops below 0.1%.
...
## 💬 Reviews & Feedback
- **@steipete** (★★★★☆ 4/5): *Successfully implemented this for MongoDB. The verification step is extremely reliable.* (2026-06-05)