# The Terraform Unused Imports Sweeps Loop

**Loop ID**: #1008 | **Category**: Content | **Author**: @brendan_e | **Rating**: ⭐ 4.2/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps unused imports in Terraform and stops when error rate drops below 0.1%.
