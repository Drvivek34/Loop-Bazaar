# The PostgreSQL Docker Images Refactors Loop

**Loop ID**: #0395 | **Category**: Content | **Author**: @vivek34 | **Rating**: ⭐ 4.4/5.0
...
## 📝 Description
A repeatable agent workflow that refactors Docker images in PostgreSQL and stops when no duplicate imports remain.
...
## 💬 Reviews & Feedback
- **@steipete** (★★★★☆ 4/5): *Successfully implemented this for PostgreSQL. The verification step is extremely reliable.* (2026-05-20)