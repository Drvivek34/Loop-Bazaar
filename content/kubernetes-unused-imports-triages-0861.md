# The Kubernetes Unused Imports Triages Loop

**Loop ID**: #0861 | **Category**: Content | **Author**: @ranvier2d2 | **Rating**: ⭐ 4.6/5.0
...
## 📝 Description
A repeatable agent workflow that triages unused imports in Kubernetes and stops when all checks pass successfully.
...
## 💬 Reviews & Feedback
- **@claudio_d** (★★★★☆ 4/5): *Successfully implemented this for Kubernetes. The verification step is extremely reliable.* (2026-06-04)