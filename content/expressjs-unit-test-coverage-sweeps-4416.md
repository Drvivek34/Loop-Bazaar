# The Express.js Unit Test Coverage Sweeps Loop

**Loop ID**: #4416 | **Category**: Content | **Author**: @lucas_k | **Rating**: ⭐ 4.7/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps unit test coverage in Express.js and stops when performance benchmark is met.
...
## 💬 Reviews & Feedback
- **@steipete** (★★★★☆ 4/5): *Successfully implemented this for Express.js. The verification step is extremely reliable.* (2026-06-01)