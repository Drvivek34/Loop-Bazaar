# The Next.js Database Queries Verifies Loop

**Loop ID**: #0516 | **Category**: Content | **Author**: @lSAAGl | **Rating**: ⭐ 4.2/5.0
...
## 📝 Description
A repeatable agent workflow that verifies database queries in Next.js and stops when API response time is under 100ms.
...
## 💬 Reviews & Feedback
- **@dennis_r** (★★★★☆ 4/5): *Successfully implemented this for Next.js. The verification step is extremely reliable.* (2026-05-14)