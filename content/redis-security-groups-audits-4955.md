# The Redis Security Groups Audits Loop

**Loop ID**: #4955 | **Category**: Content | **Author**: @richard_s | **Rating**: ⭐ 4.7/5.0
...
## 📝 Description
A repeatable agent workflow that audits security groups in Redis and stops when test coverage reaches 100%.
...
## 💬 Reviews & Feedback
- **@ada_lovelace** (★★★★☆ 4/5): *Successfully implemented this for Redis. The verification step is extremely reliable.* (2026-03-26)