# The Redis Localized Files Cleans up Loop

**Loop ID**: #0286 | **Category**: Content | **Author**: @lucas_k | **Rating**: ⭐ 4.0/5.0
...
## 📝 Description
A repeatable agent workflow that cleans up localized files in Redis and stops when all checks pass successfully.
...
## 💬 Reviews & Feedback
- **@ken_t** (★★★★☆ 4/5): *Successfully implemented this for Redis. The verification step is extremely reliable.* (2026-04-11)