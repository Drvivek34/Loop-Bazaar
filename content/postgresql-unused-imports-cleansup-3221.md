# The PostgreSQL Unused Imports Cleans up Loop

**Loop ID**: #3221 | **Category**: Content | **Author**: @sophia_w | **Rating**: ⭐ 4.5/5.0
...
## 📝 Description
A repeatable agent workflow that cleans up unused imports in PostgreSQL and stops when API response time is under 100ms.
...
## 🏷️ Keywords
postgresql, content, cleans up

## 💬 Reviews & Feedback
- **@ada_lovelace** (★★★★☆ 4/5): *Successfully implemented this for PostgreSQL. The verification step is extremely reliable.* (2026-06-19)