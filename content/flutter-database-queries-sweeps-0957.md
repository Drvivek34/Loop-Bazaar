# The Flutter Database Queries Sweeps Loop

**Loop ID**: #0957 | **Category**: Content | **Author**: @lucas_k | **Rating**: ⭐ 4.6/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps database queries in Flutter and stops when API response time is under 100ms.
...
## 💬 Reviews & Feedback
- **@vivek34** (★★★★☆ 4/5): *Successfully implemented this for Flutter. The verification step is extremely reliable.* (2026-02-04)