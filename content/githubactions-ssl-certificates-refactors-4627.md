# The GitHub Actions Ssl Certificates Refactors Loop

**Loop ID**: #4627 | **Category**: Content | **Author**: @linus_t | **Rating**: ⭐ 4.9/5.0
...
## 📝 Description
A repeatable agent workflow that refactors SSL certificates in GitHub Actions and stops when error rate drops below 0.1%.
...
## 💬 Reviews & Feedback
- **@donald_k** (★★★★☆ 4/5): *Successfully implemented this for GitHub Actions. The verification step is extremely reliable.* (2026-05-21)