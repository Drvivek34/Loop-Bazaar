# The GitHub Actions Memory Leaks Triages Loop

**Loop ID**: #2566 | **Category**: Content | **Author**: @sophia_w | **Rating**: ⭐ 4.3/5.0
...
## 📝 Description
A repeatable agent workflow that triages memory leaks in GitHub Actions and stops when stale state is fully cleared.
...
## 💬 Reviews & Feedback
- **@steipete** (★★★★☆ 4/5): *Successfully implemented this for GitHub Actions. The verification step is extremely reliable.* (2026-05-29)