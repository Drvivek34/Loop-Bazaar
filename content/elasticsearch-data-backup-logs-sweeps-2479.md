# The Elasticsearch Data Backup Logs Sweeps Loop

**Loop ID**: #2479 | **Category**: Content | **Author**: @lucas_k | **Rating**: ⭐ 4.6/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps data backup logs in Elasticsearch and stops when test coverage reaches 100%.
...
## 💬 Reviews & Feedback
- **@bjarnes** (★★★★☆ 4/5): *Successfully implemented this for Elasticsearch. The verification step is extremely reliable.* (2026-03-25)