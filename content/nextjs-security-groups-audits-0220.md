# The Next.js Security Groups Audits Loop

**Loop ID**: #0220 | **Category**: Content | **Author**: @lucas_k | **Rating**: ⭐ 4.3/5.0
...
## 📝 Description
A repeatable agent workflow that audits security groups in Next.js and stops when test coverage reaches 100%.
...
## 💬 Reviews & Feedback
- **@tim_berners** (★★★★☆ 4/5): *Successfully implemented this for Next.js. The verification step is extremely reliable.* (2026-05-23)