# The AWS Lambda Database Queries Sweeps Loop

**Loop ID**: #1358 | **Category**: Content | **Author**: @richard_s | **Rating**: ⭐ 4.5/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps database queries in AWS Lambda and stops when stale state is fully cleared.
...
## 💬 Reviews & Feedback
- **@dennis_r** (★★★★☆ 4/5): *Successfully implemented this for AWS Lambda. The verification step is extremely reliable.* (2026-03-18)