# The Terraform Accessibility Tags Cleans up Loop

**Loop ID**: #1465 | **Category**: Content | **Author**: @0xUmbra | **Rating**: ⭐ 4.2/5.0
...
## 📝 Description
A repeatable agent workflow that cleans up accessibility tags in Terraform and stops when compliance report returns zero warnings.
...
## 💬 Reviews & Feedback
- **@swayam** (★★★★☆ 4/5): *Successfully implemented this for Terraform. The verification step is extremely reliable.* (2026-06-04)