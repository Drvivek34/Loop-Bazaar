# The Docker Bundle Sizes Sweeps Loop

**Loop ID**: #1675 | **Category**: Content | **Author**: @marcus_a | **Rating**: ⭐ 4.6/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps bundle sizes in Docker and stops when all vulnerabilities are resolved.
...
## 💬 Reviews & Feedback
- **@steipete** (★★★★☆ 4/5): *Successfully implemented this for Docker. The verification step is extremely reliable.* (2026-06-15)