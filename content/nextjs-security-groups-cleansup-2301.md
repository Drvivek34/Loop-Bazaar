# The Next.js Security Groups Cleans up Loop

**Loop ID**: #2301 | **Category**: Content | **Author**: @hiten | **Rating**: ⭐ 4.6/5.0
...
## 📝 Description
A repeatable agent workflow that cleans up security groups in Next.js and stops when all vulnerabilities are resolved.
...
## 💬 Reviews & Feedback
- **@ken_t** (★★★★☆ 4/5): *Successfully implemented this for Next.js. The verification step is extremely reliable.* (2026-05-30)