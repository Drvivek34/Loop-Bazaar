# The MongoDB Cache Hit Ratios Sweeps Loop

**Loop ID**: #3939 | **Category**: Content | **Author**: @victormustar | **Rating**: ⭐ 4.2/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps cache hit ratios in MongoDB and stops when API response time is under 100ms.
...
## 🏷️ Keywords
mongodb, content, sweeps

## 💬 Reviews & Feedback
- **@swayam** (★★★★☆ 4/5): *Successfully implemented this for MongoDB. The verification step is extremely reliable.* (2026-03-05)