# The Kubernetes Security Groups Sweeps Loop

**Loop ID**: #2848 | **Category**: Content | **Author**: @linus_t | **Rating**: ⭐ 4.0/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps security groups in Kubernetes and stops when API response time is under 100ms.
...
## 💬 Reviews & Feedback
- **@donald_k** (★★★★☆ 4/5): *Successfully implemented this for Kubernetes. The verification step is extremely reliable.* (2026-03-29)