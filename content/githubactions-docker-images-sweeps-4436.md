# The GitHub Actions Docker Images Sweeps Loop

**Loop ID**: #4436 | **Category**: Content | **Author**: @ada_lovelace | **Rating**: ⭐ 4.2/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps Docker images in GitHub Actions and stops when test coverage reaches 100%.
...
## 💬 Reviews & Feedback
- **@hiten** (★★★★☆ 4/5): *Successfully implemented this for GitHub Actions. The verification step is extremely reliable.* (2026-01-02)