# The Redis Security Groups Cleans up Loop

**Loop ID**: #1077 | **Category**: Content | **Author**: @donald_k | **Rating**: ⭐ 4.4/5.0
...
## 📝 Description
A repeatable agent workflow that cleans up security groups in Redis and stops when error rate drops below 0.1%.
...
## 💬 Reviews & Feedback
- **@ken_t** (★★★★☆ 4/5): *Successfully implemented this for Redis. The verification step is extremely reliable.* (2026-05-02)