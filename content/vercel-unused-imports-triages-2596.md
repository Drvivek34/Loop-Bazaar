# The Vercel Unused Imports Triages Loop

**Loop ID**: #2596 | **Category**: Content | **Author**: @ken_t | **Rating**: ⭐ 4.5/5.0
...
## 📝 Description
A repeatable agent workflow that triages unused imports in Vercel and stops when API response time is under 100ms.
...
## 💬 Reviews & Feedback
- **@victormustar** (★★★★☆ 4/5): *Successfully implemented this for Vercel. The verification step is extremely reliable.* (2026-04-27)