# The PostgreSQL Security Groups Refactors Loop

**Loop ID**: #2372 | **Category**: Content | **Author**: @grace_hopper | **Rating**: ⭐ 4.6/5.0
...
## 📝 Description
A repeatable agent workflow that refactors security groups in PostgreSQL and stops when compliance report returns zero warnings.
...
## 💬 Reviews & Feedback
- **@lSAAGl** (★★★★☆ 4/5): *Successfully implemented this for PostgreSQL. The verification step is extremely reliable.* (2026-06-11)