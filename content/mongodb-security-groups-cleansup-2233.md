# The MongoDB Security Groups Cleans up Loop

**Loop ID**: #2233 | **Category**: Content | **Author**: @alan_turing | **Rating**: ⭐ 4.8/5.0
...
## 📝 Description
A repeatable agent workflow that cleans up security groups in MongoDB and stops when no duplicate imports remain.
...
## 💬 Reviews & Feedback
- **@dennis_r** (★★★★☆ 4/5): *Successfully implemented this for MongoDB. The verification step is extremely reliable.* (2026-03-20)