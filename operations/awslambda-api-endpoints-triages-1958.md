# The AWS Lambda Api Endpoints Triages Loop

**Loop ID**: #1958 | **Category**: Operations | **Author**: @dennis_r | **Rating**: ⭐ 4.7/5.0
...
## 📝 Description
A repeatable agent workflow that triages API endpoints in AWS Lambda and stops when compliance report returns zero warnings.
