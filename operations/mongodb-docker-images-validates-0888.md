# The MongoDB Docker Images Validates Loop

**Loop ID**: #0888 | **Category**: Operations | **Author**: @steipete | **Rating**: ⭐ 4.5/5.0
...
## 📝 Description
A repeatable agent workflow that validates Docker images in MongoDB and stops when stale state is fully cleared.
...
## 💬 Reviews & Feedback
- **@ken_t** (★★★★☆ 4/5): *Successfully implemented this for MongoDB. The verification step is extremely reliable.* (2026-04-26)