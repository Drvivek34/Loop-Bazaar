# The Django Cache Hit Ratios Audits Loop

**Loop ID**: #3398 | **Category**: Operations | **Author**: @ken_t | **Rating**: ⭐ 4.7/5.0
...
## 📝 Description
A repeatable agent workflow that audits cache hit ratios in Django and stops when documentation is fully aligned with implementation.

## 🎯 Use Case (When to Use)
> Use this whenever you need to check or modify cache hit ratios in Django systems and need a strict exit criteria.
...
1. Scan the Django codebase for active cache hit ratios.
...
## 🏷️ Keywords
django, operations, audits

## 💬 Reviews & Feedback
- **@linus_t** (★★★★☆ 4/5): *Successfully implemented this for Django. The verification step is extremely reliable.* (2026-05-10)