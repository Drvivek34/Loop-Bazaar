# The Docker Docker Images Audits Loop

**Loop ID**: #0044 | **Category**: Operations | **Author**: @elena_r | **Rating**: ⭐ 4.7/5.0
...
## 📝 Description
A repeatable agent workflow that audits Docker images in Docker and stops when target threshold is reached.
...
## 💬 Reviews & Feedback
- **@swayam** (★★★★☆ 4/5): *Successfully implemented this for Docker. The verification step is extremely reliable.* (2026-01-09)