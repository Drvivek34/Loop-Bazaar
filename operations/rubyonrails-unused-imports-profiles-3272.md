# The Ruby on Rails Unused Imports Profiles Loop

**Loop ID**: #3272 | **Category**: Operations | **Author**: @guido_vr | **Rating**: ⭐ 5.0/5.0
...
## 📝 Description
A repeatable agent workflow that profiles unused imports in Ruby on Rails and stops when documentation is fully aligned with implementation.
...
## 💬 Reviews & Feedback
- **@swayam** (★★★★★ 5/5): *Successfully implemented this for Ruby on Rails. The verification step is extremely reliable.* (2026-01-18)