# The Elasticsearch Localized Files Audits Loop

**Loop ID**: #2146 | **Category**: Operations | **Author**: @james_g | **Rating**: ⭐ 4.3/5.0
...
## 📝 Description
A repeatable agent workflow that audits localized files in Elasticsearch and stops when all vulnerabilities are resolved.
...
## 💬 Reviews & Feedback
- **@elena_r** (★★★★☆ 4/5): *Successfully implemented this for Elasticsearch. The verification step is extremely reliable.* (2026-01-23)