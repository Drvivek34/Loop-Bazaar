# The Ruby on Rails Unused Imports Cleans up Loop

**Loop ID**: #0857 | **Category**: Operations | **Author**: @alan_turing | **Rating**: ⭐ 4.5/5.0
...
## 📝 Description
A repeatable agent workflow that cleans up unused imports in Ruby on Rails and stops when stale state is fully cleared.
...
## 💬 Reviews & Feedback
- **@james_g** (★★★★☆ 4/5): *Successfully implemented this for Ruby on Rails. The verification step is extremely reliable.* (2026-04-30)