# The Elasticsearch Security Groups Refactors Loop

**Loop ID**: #2826 | **Category**: Operations | **Author**: @lucas_k | **Rating**: ⭐ 5.0/5.0
...
## 📝 Description
A repeatable agent workflow that refactors security groups in Elasticsearch and stops when no duplicate imports remain.
...
## 💬 Reviews & Feedback
- **@grace_hopper** (★★★★★ 5/5): *Successfully implemented this for Elasticsearch. The verification step is extremely reliable.* (2026-06-04)