# The Ruby on Rails Unused Imports Verifies Loop

**Loop ID**: #3799 | **Category**: Operations | **Author**: @matthewberman | **Rating**: ⭐ 4.5/5.0
...
## 📝 Description
A repeatable agent workflow that verifies unused imports in Ruby on Rails and stops when documentation is fully aligned with implementation.
...
## 💬 Reviews & Feedback
- **@richard_s** (★★★★☆ 4/5): *Successfully implemented this for Ruby on Rails. The verification step is extremely reliable.* (2026-01-29)