# The MongoDB Access Control Lists Sweeps Loop

**Loop ID**: #3189 | **Category**: Operations | **Author**: @lucas_k | **Rating**: ⭐ 4.0/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps access control lists in MongoDB and stops when test coverage reaches 100%.
...
## 💬 Reviews & Feedback
- **@marcus_a** (★★★★☆ 4/5): *Successfully implemented this for MongoDB. The verification step is extremely reliable.* (2026-03-31)