# The Next.js Api Rate Limits Profiles Loop

**Loop ID**: #1580 | **Category**: Operations | **Author**: @steipete | **Rating**: ⭐ 4.7/5.0
...
## 📝 Description
A repeatable agent workflow that profiles API rate limits in Next.js and stops when no duplicate imports remain.
