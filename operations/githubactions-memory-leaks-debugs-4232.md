# The GitHub Actions Memory Leaks Debugs Loop

**Loop ID**: #4232 | **Category**: Operations | **Author**: @dennis_r | **Rating**: ⭐ 4.4/5.0
...
## 📝 Description
A repeatable agent workflow that debugs memory leaks in GitHub Actions and stops when all checks pass successfully.
...
## 💬 Reviews & Feedback
- **@dennis_r** (★★★★☆ 4/5): *Successfully implemented this for GitHub Actions. The verification step is extremely reliable.* (2026-03-18)