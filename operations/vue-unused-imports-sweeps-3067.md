# The Vue Unused Imports Sweeps Loop

**Loop ID**: #3067 | **Category**: Operations | **Author**: @dennis_r | **Rating**: ⭐ 4.1/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps unused imports in Vue and stops when stale state is fully cleared.
...
## 💬 Reviews & Feedback
- **@guido_vr** (★★★★☆ 4/5): *Successfully implemented this for Vue. The verification step is extremely reliable.* (2026-03-21)