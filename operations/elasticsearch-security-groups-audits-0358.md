# The Elasticsearch Security Groups Audits Loop

**Loop ID**: #0358 | **Category**: Operations | **Author**: @grace_hopper | **Rating**: ⭐ 4.4/5.0
...
## 📝 Description
A repeatable agent workflow that audits security groups in Elasticsearch and stops when stale state is fully cleared.
...
## 🏷️ Keywords
elasticsearch, operations, audits

## 💬 Reviews & Feedback
- **@matthewberman** (★★★★☆ 4/5): *Successfully implemented this for Elasticsearch. The verification step is extremely reliable.* (2026-01-24)