# The MongoDB Database Queries Audits Loop

**Loop ID**: #3642 | **Category**: Operations | **Author**: @vivek34 | **Rating**: ⭐ 4.6/5.0
...
## 📝 Description
A repeatable agent workflow that audits database queries in MongoDB and stops when compliance report returns zero warnings.
...
## 🏷️ Keywords
mongodb, operations, audits

## 💬 Reviews & Feedback
- **@richard_s** (★★★★☆ 4/5): *Successfully implemented this for MongoDB. The verification step is extremely reliable.* (2026-05-13)