# The MongoDB Docker Images Refactors Loop

**Loop ID**: #4047 | **Category**: Operations | **Author**: @agent0ai | **Rating**: ⭐ 4.8/5.0
...
## 📝 Description
A repeatable agent workflow that refactors Docker images in MongoDB and stops when all vulnerabilities are resolved.
...
## 💬 Reviews & Feedback
- **@james_g** (★★★★☆ 4/5): *Successfully implemented this for MongoDB. The verification step is extremely reliable.* (2026-02-04)