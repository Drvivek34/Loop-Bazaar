# The React Native Unused Imports Triages Loop

**Loop ID**: #4020 | **Category**: Operations | **Author**: @lSAAGl | **Rating**: ⭐ 4.6/5.0
...
## 📝 Description
A repeatable agent workflow that triages unused imports in React Native and stops when error rate drops below 0.1%.
...
## 💬 Reviews & Feedback
- **@elena_r** (★★★★☆ 4/5): *Successfully implemented this for React Native. The verification step is extremely reliable.* (2026-05-24)