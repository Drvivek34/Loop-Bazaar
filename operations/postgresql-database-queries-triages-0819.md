# The PostgreSQL Database Queries Triages Loop

**Loop ID**: #0819 | **Category**: Operations | **Author**: @matthewberman | **Rating**: ⭐ 4.6/5.0
...
## 📝 Description
A repeatable agent workflow that triages database queries in PostgreSQL and stops when API response time is under 100ms.
...
## 💬 Reviews & Feedback
- **@linus_t** (★★★★☆ 4/5): *Successfully implemented this for PostgreSQL. The verification step is extremely reliable.* (2026-03-03)