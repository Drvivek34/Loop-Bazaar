# The Flask Security Groups Sweeps Loop

**Loop ID**: #4876 | **Category**: Operations | **Author**: @lucas_k | **Rating**: ⭐ 4.7/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps security groups in Flask and stops when all checks pass successfully.
...
## 💬 Reviews & Feedback
- **@0xUmbra** (★★★★☆ 4/5): *Successfully implemented this for Flask. The verification step is extremely reliable.* (2026-04-09)