# The PostgreSQL Code Documentation Drift Refactors Loop

**Loop ID**: #0671 | **Category**: Operations | **Author**: @steipete | **Rating**: ⭐ 4.3/5.0
...
## 📝 Description
A repeatable agent workflow that refactors code documentation drift in PostgreSQL and stops when stale state is fully cleared.
...
## 💬 Reviews & Feedback
- **@linus_t** (★★★★☆ 4/5): *Successfully implemented this for PostgreSQL. The verification step is extremely reliable.* (2026-03-14)