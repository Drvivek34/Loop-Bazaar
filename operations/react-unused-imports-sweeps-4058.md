# The React Unused Imports Sweeps Loop

**Loop ID**: #4058 | **Category**: Operations | **Author**: @swayam | **Rating**: ⭐ 4.6/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps unused imports in React and stops when target threshold is reached.
...
## 💬 Reviews & Feedback
- **@steipete** (★★★★☆ 4/5): *Successfully implemented this for React. The verification step is extremely reliable.* (2026-02-20)