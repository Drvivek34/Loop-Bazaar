# The Vue Security Groups Secures Loop

**Loop ID**: #3434 | **Category**: Operations | **Author**: @ranvier2d2 | **Rating**: ⭐ 4.3/5.0
...
## 📝 Description
A repeatable agent workflow that secures security groups in Vue and stops when stale state is fully cleared.
...
## 💬 Reviews & Feedback
- **@steipete** (★★★★☆ 4/5): *Successfully implemented this for Vue. The verification step is extremely reliable.* (2026-05-25)