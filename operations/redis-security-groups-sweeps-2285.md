# The Redis Security Groups Sweeps Loop

**Loop ID**: #2285 | **Category**: Operations | **Author**: @elena_r | **Rating**: ⭐ 4.5/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps security groups in Redis and stops when no duplicate imports remain.
...
## 💬 Reviews & Feedback
- **@agent0ai** (★★★★☆ 4/5): *Successfully implemented this for Redis. The verification step is extremely reliable.* (2026-05-28)