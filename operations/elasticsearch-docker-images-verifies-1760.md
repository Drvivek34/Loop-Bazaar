# The Elasticsearch Docker Images Verifies Loop

**Loop ID**: #1760 | **Category**: Operations | **Author**: @vivek34 | **Rating**: ⭐ 4.4/5.0
...
## 📝 Description
A repeatable agent workflow that verifies Docker images in Elasticsearch and stops when stale state is fully cleared.
...
## 🏷️ Keywords
elasticsearch, operations, verifies
