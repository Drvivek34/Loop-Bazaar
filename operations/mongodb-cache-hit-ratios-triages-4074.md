# The MongoDB Cache Hit Ratios Triages Loop

**Loop ID**: #4074 | **Category**: Operations | **Author**: @ken_t | **Rating**: ⭐ 4.8/5.0
...
## 📝 Description
A repeatable agent workflow that triages cache hit ratios in MongoDB and stops when error rate drops below 0.1%.
...
## 🏷️ Keywords
mongodb, operations, triages

## 💬 Reviews & Feedback
- **@steipete** (★★★★☆ 4/5): *Successfully implemented this for MongoDB. The verification step is extremely reliable.* (2026-02-18)