# The GitHub Actions Database Queries Profiles Loop

**Loop ID**: #0351 | **Category**: Operations | **Author**: @marcus_a | **Rating**: ⭐ 4.6/5.0
...
## 📝 Description
A repeatable agent workflow that profiles database queries in GitHub Actions and stops when stale state is fully cleared.
...
## 💬 Reviews & Feedback
- **@steipete** (★★★★☆ 4/5): *Successfully implemented this for GitHub Actions. The verification step is extremely reliable.* (2026-06-03)