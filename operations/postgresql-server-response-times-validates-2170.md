# The PostgreSQL Server Response Times Validates Loop

**Loop ID**: #2170 | **Category**: Operations | **Author**: @steipete | **Rating**: ⭐ 4.1/5.0
...
## 📝 Description
A repeatable agent workflow that validates server response times in PostgreSQL and stops when performance benchmark is met.
...
## 💬 Reviews & Feedback
- **@lSAAGl** (★★★★☆ 4/5): *Successfully implemented this for PostgreSQL. The verification step is extremely reliable.* (2026-02-13)