# The NestJS Unused Imports Debugs Loop

**Loop ID**: #3644 | **Category**: Operations | **Author**: @sophia_w | **Rating**: ⭐ 4.2/5.0
...
## 📝 Description
A repeatable agent workflow that debugs unused imports in NestJS and stops when stale state is fully cleared.
...
## 🏷️ Keywords
nestjs, operations, debugs

## 💬 Reviews & Feedback
- **@brendan_e** (★★★★☆ 4/5): *Successfully implemented this for NestJS. The verification step is extremely reliable.* (2026-03-27)