# The PostgreSQL Memory Leaks Triages Loop

**Loop ID**: #0765 | **Category**: Operations | **Author**: @marcus_a | **Rating**: ⭐ 4.5/5.0
...
## 📝 Description
A repeatable agent workflow that triages memory leaks in PostgreSQL and stops when no regressions are detected.
...
## 💬 Reviews & Feedback
- **@0xUmbra** (★★★★☆ 4/5): *Successfully implemented this for PostgreSQL. The verification step is extremely reliable.* (2026-01-11)