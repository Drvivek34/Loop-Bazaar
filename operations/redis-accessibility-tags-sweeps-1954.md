# The Redis Accessibility Tags Sweeps Loop

**Loop ID**: #1954 | **Category**: Operations | **Author**: @claudio_d | **Rating**: ⭐ 4.9/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps accessibility tags in Redis and stops when API response time is under 100ms.
...
## 🏷️ Keywords
redis, operations, sweeps

## 💬 Reviews & Feedback
- **@grace_hopper** (★★★★☆ 4/5): *Successfully implemented this for Redis. The verification step is extremely reliable.* (2026-01-30)