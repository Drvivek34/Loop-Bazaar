# The Vue Security Groups Sweeps Loop

**Loop ID**: #1519 | **Category**: Operations | **Author**: @ada_lovelace | **Rating**: ⭐ 4.6/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps security groups in Vue and stops when error rate drops below 0.1%.
...
## 🏷️ Keywords
vue, operations, sweeps

## 💬 Reviews & Feedback
- **@dennis_r** (★★★★☆ 4/5): *Successfully implemented this for Vue. The verification step is extremely reliable.* (2026-04-30)