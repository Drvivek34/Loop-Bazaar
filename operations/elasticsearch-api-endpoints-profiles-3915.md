# The Elasticsearch Api Endpoints Profiles Loop

**Loop ID**: #3915 | **Category**: Operations | **Author**: @ken_t | **Rating**: ⭐ 5.0/5.0
...
## 📝 Description
A repeatable agent workflow that profiles API endpoints in Elasticsearch and stops when compliance report returns zero warnings.
...
## 💬 Reviews & Feedback
- **@donald_k** (★★★★★ 5/5): *Successfully implemented this for Elasticsearch. The verification step is extremely reliable.* (2026-02-12)