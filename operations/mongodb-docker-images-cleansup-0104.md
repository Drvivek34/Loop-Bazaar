# The MongoDB Docker Images Cleans up Loop

**Loop ID**: #0104 | **Category**: Operations | **Author**: @ranvier2d2 | **Rating**: ⭐ 4.1/5.0
...
## 📝 Description
A repeatable agent workflow that cleans up Docker images in MongoDB and stops when test coverage reaches 100%.
...
## 💬 Reviews & Feedback
- **@vivek34** (★★★★☆ 4/5): *Successfully implemented this for MongoDB. The verification step is extremely reliable.* (2026-03-03)