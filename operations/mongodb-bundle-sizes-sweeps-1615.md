# The MongoDB Bundle Sizes Sweeps Loop

**Loop ID**: #1615 | **Category**: Operations | **Author**: @hiten | **Rating**: ⭐ 4.5/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps bundle sizes in MongoDB and stops when stale state is fully cleared.
...
## 💬 Reviews & Feedback
- **@james_g** (★★★★☆ 4/5): *Successfully implemented this for MongoDB. The verification step is extremely reliable.* (2026-05-09)