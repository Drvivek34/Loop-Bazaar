# The PostgreSQL Api Endpoints Triages Loop

**Loop ID**: #4028 | **Category**: Evaluation | **Author**: @bjarnes | **Rating**: ⭐ 4.5/5.0
...
## 📝 Description
A repeatable agent workflow that triages API endpoints in PostgreSQL and stops when no regressions are detected.
...
## 💬 Reviews & Feedback
- **@inferencegod** (★★★★☆ 4/5): *Successfully implemented this for PostgreSQL. The verification step is extremely reliable.* (2026-02-20)