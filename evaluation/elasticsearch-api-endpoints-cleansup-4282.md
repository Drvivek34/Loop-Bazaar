# The Elasticsearch Api Endpoints Cleans up Loop

**Loop ID**: #4282 | **Category**: Evaluation | **Author**: @0xUmbra | **Rating**: ⭐ 4.4/5.0
...
## 📝 Description
A repeatable agent workflow that cleans up API endpoints in Elasticsearch and stops when stale state is fully cleared.
...
## 💬 Reviews & Feedback
- **@guido_vr** (★★★★☆ 4/5): *Successfully implemented this for Elasticsearch. The verification step is extremely reliable.* (2026-02-02)