# The MongoDB Docker Images Audits Loop

**Loop ID**: #1096 | **Category**: Evaluation | **Author**: @james_g | **Rating**: ⭐ 4.3/5.0
...
## 📝 Description
A repeatable agent workflow that audits Docker images in MongoDB and stops when all checks pass successfully.
