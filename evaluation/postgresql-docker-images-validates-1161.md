# The PostgreSQL Docker Images Validates Loop

**Loop ID**: #1161 | **Category**: Evaluation | **Author**: @sophia_w | **Rating**: ⭐ 4.1/5.0
...
## 📝 Description
A repeatable agent workflow that validates Docker images in PostgreSQL and stops when performance benchmark is met.
...
## 💬 Reviews & Feedback
- **@lucas_k** (★★★★☆ 4/5): *Successfully implemented this for PostgreSQL. The verification step is extremely reliable.* (2026-02-12)