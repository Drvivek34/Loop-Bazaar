# The Kubernetes Ssl Certificates Verifies Loop

**Loop ID**: #1451 | **Category**: Evaluation | **Author**: @steipete | **Rating**: ⭐ 4.0/5.0
...
## 📝 Description
A repeatable agent workflow that verifies SSL certificates in Kubernetes and stops when performance benchmark is met.
...
## 💬 Reviews & Feedback
- **@steipete** (★★★★☆ 4/5): *Successfully implemented this for Kubernetes. The verification step is extremely reliable.* (2026-06-17)