# The Kubernetes Security Groups Audits Loop

**Loop ID**: #2921 | **Category**: Evaluation | **Author**: @richard_s | **Rating**: ⭐ 4.4/5.0
...
## 📝 Description
A repeatable agent workflow that audits security groups in Kubernetes and stops when stale state is fully cleared.
...
## 💬 Reviews & Feedback
- **@grace_hopper** (★★★★☆ 4/5): *Successfully implemented this for Kubernetes. The verification step is extremely reliable.* (2026-01-01)