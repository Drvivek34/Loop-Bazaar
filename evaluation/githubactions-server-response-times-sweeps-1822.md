# The GitHub Actions Server Response Times Sweeps Loop

**Loop ID**: #1822 | **Category**: Evaluation | **Author**: @steipete | **Rating**: ⭐ 4.5/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps server response times in GitHub Actions and stops when test coverage reaches 100%.
...
## 💬 Reviews & Feedback
- **@grace_hopper** (★★★★☆ 4/5): *Successfully implemented this for GitHub Actions. The verification step is extremely reliable.* (2026-05-01)