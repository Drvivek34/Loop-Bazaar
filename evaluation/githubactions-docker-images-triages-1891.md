# The GitHub Actions Docker Images Triages Loop

**Loop ID**: #1891 | **Category**: Evaluation | **Author**: @agent0ai | **Rating**: ⭐ 4.6/5.0
...
## 📝 Description
A repeatable agent workflow that triages Docker images in GitHub Actions and stops when error rate drops below 0.1%.
...
## 💬 Reviews & Feedback
- **@matthewberman** (★★★★☆ 4/5): *Successfully implemented this for GitHub Actions. The verification step is extremely reliable.* (2026-04-13)