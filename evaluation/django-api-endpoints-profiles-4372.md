# The Django Api Endpoints Profiles Loop

**Loop ID**: #4372 | **Category**: Evaluation | **Author**: @matthewberman | **Rating**: ⭐ 4.7/5.0
...
## 📝 Description
A repeatable agent workflow that profiles API endpoints in Django and stops when API response time is under 100ms.
...
## 💬 Reviews & Feedback
- **@0xUmbra** (★★★★☆ 4/5): *Successfully implemented this for Django. The verification step is extremely reliable.* (2026-01-22)