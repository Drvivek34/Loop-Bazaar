# The GitHub Actions Api Rate Limits Validates Loop

**Loop ID**: #2119 | **Category**: Evaluation | **Author**: @tim_berners | **Rating**: ⭐ 4.6/5.0
...
## 📝 Description
A repeatable agent workflow that validates API rate limits in GitHub Actions and stops when compliance report returns zero warnings.
...
## 🏷️ Keywords
github actions, evaluation, validates

## 💬 Reviews & Feedback
- **@swayam** (★★★★☆ 4/5): *Successfully implemented this for GitHub Actions. The verification step is extremely reliable.* (2026-05-04)