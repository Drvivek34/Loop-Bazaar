# The AWS Lambda Accessibility Tags Validates Loop

**Loop ID**: #2421 | **Category**: Evaluation | **Author**: @james_g | **Rating**: ⭐ 4.4/5.0
...
## 📝 Description
A repeatable agent workflow that validates accessibility tags in AWS Lambda and stops when no duplicate imports remain.
...
## 💬 Reviews & Feedback
- **@swayam** (★★★★☆ 4/5): *Successfully implemented this for AWS Lambda. The verification step is extremely reliable.* (2026-04-07)