# The PostgreSQL Docker Images Optimizes Loop

**Loop ID**: #3995 | **Category**: Evaluation | **Author**: @donald_k | **Rating**: ⭐ 4.9/5.0
...
## 📝 Description
A repeatable agent workflow that optimizes Docker images in PostgreSQL and stops when no duplicate imports remain.
