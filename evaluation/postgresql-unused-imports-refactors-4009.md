# The PostgreSQL Unused Imports Refactors Loop

**Loop ID**: #4009 | **Category**: Evaluation | **Author**: @claudio_d | **Rating**: ⭐ 4.3/5.0
...
## 📝 Description
A repeatable agent workflow that refactors unused imports in PostgreSQL and stops when target threshold is reached.
...
## 💬 Reviews & Feedback
- **@lucas_k** (★★★★☆ 4/5): *Successfully implemented this for PostgreSQL. The verification step is extremely reliable.* (2026-02-06)