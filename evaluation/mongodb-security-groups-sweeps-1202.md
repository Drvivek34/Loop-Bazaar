# The MongoDB Security Groups Sweeps Loop

**Loop ID**: #1202 | **Category**: Evaluation | **Author**: @elena_r | **Rating**: ⭐ 4.3/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps security groups in MongoDB and stops when no regressions are detected.
...
## 💬 Reviews & Feedback
- **@agent0ai** (★★★★☆ 4/5): *Successfully implemented this for MongoDB. The verification step is extremely reliable.* (2026-02-13)