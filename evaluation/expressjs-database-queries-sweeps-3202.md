# The Express.js Database Queries Sweeps Loop

**Loop ID**: #3202 | **Category**: Evaluation | **Author**: @matthewberman | **Rating**: ⭐ 4.5/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps database queries in Express.js and stops when documentation is fully aligned with implementation.
...
## 💬 Reviews & Feedback
- **@donald_k** (★★★★☆ 4/5): *Successfully implemented this for Express.js. The verification step is extremely reliable.* (2026-05-03)