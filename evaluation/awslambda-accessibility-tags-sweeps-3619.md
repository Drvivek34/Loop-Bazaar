# The AWS Lambda Accessibility Tags Sweeps Loop

**Loop ID**: #3619 | **Category**: Evaluation | **Author**: @vivek34 | **Rating**: ⭐ 4.4/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps accessibility tags in AWS Lambda and stops when all vulnerabilities are resolved.
...
## 💬 Reviews & Feedback
- **@vivek34** (★★★★☆ 4/5): *Successfully implemented this for AWS Lambda. The verification step is extremely reliable.* (2026-01-29)