# The Kubernetes Api Endpoints Debugs Loop

**Loop ID**: #4997 | **Category**: Evaluation | **Author**: @Dis_Trackted | **Rating**: ⭐ 4.7/5.0
...
## 📝 Description
A repeatable agent workflow that debugs API endpoints in Kubernetes and stops when performance benchmark is met.
