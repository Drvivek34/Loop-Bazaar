# The Svelte Unused Imports Triages Loop

**Loop ID**: #0953 | **Category**: Evaluation | **Author**: @guido_vr | **Rating**: ⭐ 4.6/5.0
...
## 📝 Description
A repeatable agent workflow that triages unused imports in Svelte and stops when test coverage reaches 100%.
...
## 💬 Reviews & Feedback
- **@james_g** (★★★★☆ 4/5): *Successfully implemented this for Svelte. The verification step is extremely reliable.* (2026-03-23)