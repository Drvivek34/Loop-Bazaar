# The Next.js Unused Imports Sweeps Loop

**Loop ID**: #0799 | **Category**: Evaluation | **Author**: @0xUmbra | **Rating**: ⭐ 4.5/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps unused imports in Next.js and stops when compliance report returns zero warnings.
...
## 💬 Reviews & Feedback
- **@bjarnes** (★★★★☆ 4/5): *Successfully implemented this for Next.js. The verification step is extremely reliable.* (2026-03-14)