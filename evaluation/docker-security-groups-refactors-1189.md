# The Docker Security Groups Refactors Loop

**Loop ID**: #1189 | **Category**: Evaluation | **Author**: @ranvier2d2 | **Rating**: ⭐ 4.3/5.0
...
## 📝 Description
A repeatable agent workflow that refactors security groups in Docker and stops when test coverage reaches 100%.
...
## 💬 Reviews & Feedback
- **@lSAAGl** (★★★★☆ 4/5): *Successfully implemented this for Docker. The verification step is extremely reliable.* (2026-05-15)