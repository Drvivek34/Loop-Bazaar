# The PostgreSQL Seo Keywords Verifies Loop

**Loop ID**: #2063 | **Category**: Evaluation | **Author**: @guido_vr | **Rating**: ⭐ 5.0/5.0
...
## 📝 Description
A repeatable agent workflow that verifies SEO keywords in PostgreSQL and stops when error rate drops below 0.1%.
...
## 💬 Reviews & Feedback
- **@agent0ai** (★★★★★ 5/5): *Successfully implemented this for PostgreSQL. The verification step is extremely reliable.* (2026-05-16)