# The MongoDB Git Hooks Configuration Sweeps Loop

**Loop ID**: #1933 | **Category**: Evaluation | **Author**: @guido_vr | **Rating**: ⭐ 4.2/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps Git hooks configuration in MongoDB and stops when target threshold is reached.
...
## 🏷️ Keywords
mongodb, evaluation, sweeps

## 💬 Reviews & Feedback
- **@0xUmbra** (★★★★☆ 4/5): *Successfully implemented this for MongoDB. The verification step is extremely reliable.* (2026-02-24)