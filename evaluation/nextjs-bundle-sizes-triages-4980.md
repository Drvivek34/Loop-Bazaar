# The Next.js Bundle Sizes Triages Loop

**Loop ID**: #4980 | **Category**: Evaluation | **Author**: @linus_t | **Rating**: ⭐ 4.5/5.0
...
## 📝 Description
A repeatable agent workflow that triages bundle sizes in Next.js and stops when test coverage reaches 100%.
...
## 💬 Reviews & Feedback
- **@alan_turing** (★★★★☆ 4/5): *Successfully implemented this for Next.js. The verification step is extremely reliable.* (2026-03-12)