# The Elasticsearch Ssl Certificates Sweeps Loop

**Loop ID**: #1115 | **Category**: Evaluation | **Author**: @marcus_a | **Rating**: ⭐ 4.8/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps SSL certificates in Elasticsearch and stops when stale state is fully cleared.
...
## 💬 Reviews & Feedback
- **@tim_berners** (★★★★☆ 4/5): *Successfully implemented this for Elasticsearch. The verification step is extremely reliable.* (2026-04-21)