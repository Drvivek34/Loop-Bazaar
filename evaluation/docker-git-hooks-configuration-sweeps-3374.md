# The Docker Git Hooks Configuration Sweeps Loop

**Loop ID**: #3374 | **Category**: Evaluation | **Author**: @marcus_a | **Rating**: ⭐ 4.8/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps Git hooks configuration in Docker and stops when target threshold is reached.
...
## 💬 Reviews & Feedback
- **@agent0ai** (★★★★☆ 4/5): *Successfully implemented this for Docker. The verification step is extremely reliable.* (2026-03-14)