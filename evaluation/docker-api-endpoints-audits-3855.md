# The Docker Api Endpoints Audits Loop

**Loop ID**: #3855 | **Category**: Evaluation | **Author**: @bjarnes | **Rating**: ⭐ 4.3/5.0
...
## 📝 Description
A repeatable agent workflow that audits API endpoints in Docker and stops when all vulnerabilities are resolved.
...
## 💬 Reviews & Feedback
- **@steipete** (★★★★☆ 4/5): *Successfully implemented this for Docker. The verification step is extremely reliable.* (2026-02-19)