# The Flutter Memory Leaks Triages Loop

**Loop ID**: #1747 | **Category**: Evaluation | **Author**: @dennis_r | **Rating**: ⭐ 4.7/5.0
...
## 📝 Description
A repeatable agent workflow that triages memory leaks in Flutter and stops when stale state is fully cleared.
...
## 💬 Reviews & Feedback
- **@dennis_r** (★★★★☆ 4/5): *Successfully implemented this for Flutter. The verification step is extremely reliable.* (2026-03-14)