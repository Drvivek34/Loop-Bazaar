# The PostgreSQL Unit Test Coverage Verifies Loop

**Loop ID**: #2636 | **Category**: Evaluation | **Author**: @dennis_r | **Rating**: ⭐ 4.7/5.0
...
## 📝 Description
A repeatable agent workflow that verifies unit test coverage in PostgreSQL and stops when error rate drops below 0.1%.
...
## 💬 Reviews & Feedback
- **@dennis_r** (★★★★☆ 4/5): *Successfully implemented this for PostgreSQL. The verification step is extremely reliable.* (2026-01-29)