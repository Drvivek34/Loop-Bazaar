# The AWS Lambda Database Queries Debugs Loop

**Loop ID**: #0940 | **Category**: Evaluation | **Author**: @steipete | **Rating**: ⭐ 4.4/5.0
...
## 📝 Description
A repeatable agent workflow that debugs database queries in AWS Lambda and stops when stale state is fully cleared.
...
## 💬 Reviews & Feedback
- **@ranvier2d2** (★★★★☆ 4/5): *Successfully implemented this for AWS Lambda. The verification step is extremely reliable.* (2026-04-03)