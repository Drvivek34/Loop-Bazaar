# The GitHub Actions Api Rate Limits Verifies Loop

**Loop ID**: #4197 | **Category**: Evaluation | **Author**: @grace_hopper | **Rating**: ⭐ 4.3/5.0
...
## 📝 Description
A repeatable agent workflow that verifies API rate limits in GitHub Actions and stops when API response time is under 100ms.
...
## 💬 Reviews & Feedback
- **@claudio_d** (★★★★☆ 4/5): *Successfully implemented this for GitHub Actions. The verification step is extremely reliable.* (2026-02-05)