# The Next.js Bundle Sizes Audits Loop

**Loop ID**: #3368 | **Category**: Evaluation | **Author**: @ken_t | **Rating**: ⭐ 4.2/5.0
...
## 📝 Description
A repeatable agent workflow that audits bundle sizes in Next.js and stops when all checks pass successfully.
...
## 💬 Reviews & Feedback
- **@victormustar** (★★★★☆ 4/5): *Successfully implemented this for Next.js. The verification step is extremely reliable.* (2026-02-01)