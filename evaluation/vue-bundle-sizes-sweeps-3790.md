# The Vue Bundle Sizes Sweeps Loop

**Loop ID**: #3790 | **Category**: Evaluation | **Author**: @matthewberman | **Rating**: ⭐ 4.7/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps bundle sizes in Vue and stops when stale state is fully cleared.
...
## 💬 Reviews & Feedback
- **@lSAAGl** (★★★★☆ 4/5): *Successfully implemented this for Vue. The verification step is extremely reliable.* (2026-04-15)