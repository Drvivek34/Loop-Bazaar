# The Vercel Ssl Certificates Verifies Loop

**Loop ID**: #3971 | **Category**: Evaluation | **Author**: @matthewberman | **Rating**: ⭐ 4.3/5.0
...
## 📝 Description
A repeatable agent workflow that verifies SSL certificates in Vercel and stops when stale state is fully cleared.
...
## 💬 Reviews & Feedback
- **@guido_vr** (★★★★☆ 4/5): *Successfully implemented this for Vercel. The verification step is extremely reliable.* (2026-03-06)