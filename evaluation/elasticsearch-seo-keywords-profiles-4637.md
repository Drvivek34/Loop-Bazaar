# The Elasticsearch Seo Keywords Profiles Loop

**Loop ID**: #4637 | **Category**: Evaluation | **Author**: @steipete | **Rating**: ⭐ 4.8/5.0
...
## 📝 Description
A repeatable agent workflow that profiles SEO keywords in Elasticsearch and stops when test coverage reaches 100%.
...
## 🏷️ Keywords
elasticsearch, evaluation, profiles

## 💬 Reviews & Feedback
- **@vivek34** (★★★★☆ 4/5): *Successfully implemented this for Elasticsearch. The verification step is extremely reliable.* (2026-05-29)