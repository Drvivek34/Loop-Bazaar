# The PostgreSQL Server Response Times Sweeps Loop

**Loop ID**: #4630 | **Category**: Evaluation | **Author**: @brendan_e | **Rating**: ⭐ 4.2/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps server response times in PostgreSQL and stops when test coverage reaches 100%.
...
## 💬 Reviews & Feedback
- **@dennis_r** (★★★★☆ 4/5): *Successfully implemented this for PostgreSQL. The verification step is extremely reliable.* (2026-06-20)