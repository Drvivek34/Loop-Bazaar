# The Redis Unused Imports Cleans up Loop

**Loop ID**: #0224 | **Category**: Evaluation | **Author**: @0xUmbra | **Rating**: ⭐ 4.1/5.0
...
## 📝 Description
A repeatable agent workflow that cleans up unused imports in Redis and stops when test coverage reaches 100%.
