# The GitHub Actions Api Rate Limits Profiles Loop

**Loop ID**: #1665 | **Category**: Evaluation | **Author**: @swayam | **Rating**: ⭐ 4.9/5.0
...
## 📝 Description
A repeatable agent workflow that profiles API rate limits in GitHub Actions and stops when no regressions are detected.
...
## 💬 Reviews & Feedback
- **@claudio_d** (★★★★☆ 4/5): *Successfully implemented this for GitHub Actions. The verification step is extremely reliable.* (2026-06-02)