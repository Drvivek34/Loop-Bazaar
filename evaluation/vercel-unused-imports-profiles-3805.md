# The Vercel Unused Imports Profiles Loop

**Loop ID**: #3805 | **Category**: Evaluation | **Author**: @donald_k | **Rating**: ⭐ 4.6/5.0
...
## 📝 Description
A repeatable agent workflow that profiles unused imports in Vercel and stops when all checks pass successfully.
...
## 💬 Reviews & Feedback
- **@lucas_k** (★★★★☆ 4/5): *Successfully implemented this for Vercel. The verification step is extremely reliable.* (2026-03-18)