# The Express.js Database Queries Refactors Loop

**Loop ID**: #0363 | **Category**: Evaluation | **Author**: @marcus_a | **Rating**: ⭐ 4.3/5.0
...
## 📝 Description
A repeatable agent workflow that refactors database queries in Express.js and stops when no duplicate imports remain.
...
## 💬 Reviews & Feedback
- **@swayam** (★★★★☆ 4/5): *Successfully implemented this for Express.js. The verification step is extremely reliable.* (2026-05-08)