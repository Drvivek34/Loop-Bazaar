# The AWS Lambda Unused Imports Secures Loop

**Loop ID**: #1251 | **Category**: Evaluation | **Author**: @linus_t | **Rating**: ⭐ 4.6/5.0
...
## 📝 Description
A repeatable agent workflow that secures unused imports in AWS Lambda and stops when stale state is fully cleared.
...
## 💬 Reviews & Feedback
- **@agent0ai** (★★★★☆ 4/5): *Successfully implemented this for AWS Lambda. The verification step is extremely reliable.* (2026-05-31)