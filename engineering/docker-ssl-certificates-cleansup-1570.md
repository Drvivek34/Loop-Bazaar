# The Docker Ssl Certificates Cleans up Loop

**Loop ID**: #1570 | **Category**: Engineering | **Author**: @guido_vr | **Rating**: ⭐ 4.7/5.0
...
## 📝 Description
A repeatable agent workflow that cleans up SSL certificates in Docker and stops when stale state is fully cleared.
...
## 💬 Reviews & Feedback
- **@guido_vr** (★★★★☆ 4/5): *Successfully implemented this for Docker. The verification step is extremely reliable.* (2026-01-03)