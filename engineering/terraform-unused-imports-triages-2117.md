# The Terraform Unused Imports Triages Loop

**Loop ID**: #2117 | **Category**: Engineering | **Author**: @lucas_k | **Rating**: ⭐ 4.1/5.0
...
## 📝 Description
A repeatable agent workflow that triages unused imports in Terraform and stops when compliance report returns zero warnings.
...
## 💬 Reviews & Feedback
- **@swayam** (★★★★☆ 4/5): *Successfully implemented this for Terraform. The verification step is extremely reliable.* (2026-06-08)