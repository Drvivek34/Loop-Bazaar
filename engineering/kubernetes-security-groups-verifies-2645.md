# The Kubernetes Security Groups Verifies Loop

**Loop ID**: #2645 | **Category**: Engineering | **Author**: @swayam | **Rating**: ⭐ 4.4/5.0
...
## 📝 Description
A repeatable agent workflow that verifies security groups in Kubernetes and stops when no duplicate imports remain.
