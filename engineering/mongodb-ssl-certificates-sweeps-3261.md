# The MongoDB Ssl Certificates Sweeps Loop

**Loop ID**: #3261 | **Category**: Engineering | **Author**: @linus_t | **Rating**: ⭐ 4.4/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps SSL certificates in MongoDB and stops when target threshold is reached.
...
## 💬 Reviews & Feedback
- **@lSAAGl** (★★★★☆ 4/5): *Successfully implemented this for MongoDB. The verification step is extremely reliable.* (2026-06-03)