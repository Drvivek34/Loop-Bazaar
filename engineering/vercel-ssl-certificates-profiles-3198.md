# The Vercel Ssl Certificates Profiles Loop

**Loop ID**: #3198 | **Category**: Engineering | **Author**: @lucas_k | **Rating**: ⭐ 4.6/5.0
...
## 📝 Description
A repeatable agent workflow that profiles SSL certificates in Vercel and stops when no duplicate imports remain.
...
## 💬 Reviews & Feedback
- **@james_g** (★★★★☆ 4/5): *Successfully implemented this for Vercel. The verification step is extremely reliable.* (2026-03-23)