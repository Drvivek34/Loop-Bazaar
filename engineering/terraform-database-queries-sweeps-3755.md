# The Terraform Database Queries Sweeps Loop

**Loop ID**: #3755 | **Category**: Engineering | **Author**: @inferencegod | **Rating**: ⭐ 4.6/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps database queries in Terraform and stops when target threshold is reached.
