# The Elasticsearch Seo Keywords Debugs Loop

**Loop ID**: #0625 | **Category**: Engineering | **Author**: @claudio_d | **Rating**: ⭐ 4.5/5.0
...
## 📝 Description
A repeatable agent workflow that debugs SEO keywords in Elasticsearch and stops when all checks pass successfully.
...
## 💬 Reviews & Feedback
- **@ada_lovelace** (★★★★☆ 4/5): *Successfully implemented this for Elasticsearch. The verification step is extremely reliable.* (2026-02-07)