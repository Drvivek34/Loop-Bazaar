...
**Loop ID**: #035 | **Category**: Engineering | **Author**: michael Guo (@michaelzsguo) | **Rating**: ⭐ 5.0/5.0
...
**Verification Check**: The planning files say what to build, how to judge it, and when to stop.
- *Detail*: Every done_when completion check names observable evidence, the quick and final checks can actually run, the environment is ready, and unresolved decisions are clearly marked not ready.
...
## 🏷️ Keywords
Goal Forge, Codex goal planning, SPEC.md, GOAL.md, autonomous coding contract
