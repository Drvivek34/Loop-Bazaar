# The GitHub Actions Svg Assets Cleans up Loop

**Loop ID**: #4078 | **Category**: Engineering | **Author**: @guido_vr | **Rating**: ⭐ 4.2/5.0
...
## 📝 Description
A repeatable agent workflow that cleans up SVG assets in GitHub Actions and stops when documentation is fully aligned with implementation.
...
## 💬 Reviews & Feedback
- **@bjarnes** (★★★★☆ 4/5): *Successfully implemented this for GitHub Actions. The verification step is extremely reliable.* (2026-01-06)