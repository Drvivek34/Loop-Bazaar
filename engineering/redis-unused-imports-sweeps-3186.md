# The Redis Unused Imports Sweeps Loop

**Loop ID**: #3186 | **Category**: Engineering | **Author**: @swayam | **Rating**: ⭐ 4.3/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps unused imports in Redis and stops when all checks pass successfully.
...
## 💬 Reviews & Feedback
- **@marcus_a** (★★★★☆ 4/5): *Successfully implemented this for Redis. The verification step is extremely reliable.* (2026-04-12)