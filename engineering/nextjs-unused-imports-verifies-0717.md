# The Next.js Unused Imports Verifies Loop

**Loop ID**: #0717 | **Category**: Engineering | **Author**: @claudio_d | **Rating**: ⭐ 4.8/5.0
...
## 📝 Description
A repeatable agent workflow that verifies unused imports in Next.js and stops when no duplicate imports remain.
...
## 🏷️ Keywords
next.js, engineering, verifies

## 💬 Reviews & Feedback
- **@elena_r** (★★★★☆ 4/5): *Successfully implemented this for Next.js. The verification step is extremely reliable.* (2026-04-26)