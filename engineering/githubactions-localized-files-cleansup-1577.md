# The GitHub Actions Localized Files Cleans up Loop

**Loop ID**: #1577 | **Category**: Engineering | **Author**: @lSAAGl | **Rating**: ⭐ 5.0/5.0
...
## 📝 Description
A repeatable agent workflow that cleans up localized files in GitHub Actions and stops when compliance report returns zero warnings.
...
## 💬 Reviews & Feedback
- **@lucas_k** (★★★★★ 5/5): *Successfully implemented this for GitHub Actions. The verification step is extremely reliable.* (2026-06-12)