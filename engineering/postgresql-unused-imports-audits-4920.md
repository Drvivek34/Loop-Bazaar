# The PostgreSQL Unused Imports Audits Loop

**Loop ID**: #4920 | **Category**: Engineering | **Author**: @claudio_d | **Rating**: ⭐ 4.9/5.0
...
## 📝 Description
A repeatable agent workflow that audits unused imports in PostgreSQL and stops when compliance report returns zero warnings.
...
## 💬 Reviews & Feedback
- **@claudio_d** (★★★★☆ 4/5): *Successfully implemented this for PostgreSQL. The verification step is extremely reliable.* (2026-05-22)