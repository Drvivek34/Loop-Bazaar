# The GitHub Actions Docker Images Refactors Loop

**Loop ID**: #0928 | **Category**: Engineering | **Author**: @richard_s | **Rating**: ⭐ 4.0/5.0
...
## 📝 Description
A repeatable agent workflow that refactors Docker images in GitHub Actions and stops when stale state is fully cleared.
...
## 💬 Reviews & Feedback
- **@alan_turing** (★★★★☆ 4/5): *Successfully implemented this for GitHub Actions. The verification step is extremely reliable.* (2026-05-12)