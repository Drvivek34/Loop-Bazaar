# The PostgreSQL Seo Keywords Debugs Loop

**Loop ID**: #4585 | **Category**: Engineering | **Author**: @ranvier2d2 | **Rating**: ⭐ 4.6/5.0
...
## 📝 Description
A repeatable agent workflow that debugs SEO keywords in PostgreSQL and stops when performance benchmark is met.
...
## 💬 Reviews & Feedback
- **@tim_berners** (★★★★☆ 4/5): *Successfully implemented this for PostgreSQL. The verification step is extremely reliable.* (2026-04-19)