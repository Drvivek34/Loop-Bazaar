# The Terraform Seo Keywords Sweeps Loop

**Loop ID**: #2885 | **Category**: Engineering | **Author**: @ada_lovelace | **Rating**: ⭐ 4.6/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps SEO keywords in Terraform and stops when target threshold is reached.
...
## 💬 Reviews & Feedback
- **@Dis_Trackted** (★★★★☆ 4/5): *Successfully implemented this for Terraform. The verification step is extremely reliable.* (2026-04-22)