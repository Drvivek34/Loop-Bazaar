# The AWS Lambda Security Groups Triages Loop

**Loop ID**: #1067 | **Category**: Engineering | **Author**: @elena_r | **Rating**: ⭐ 4.0/5.0
...
## 📝 Description
A repeatable agent workflow that triages security groups in AWS Lambda and stops when all checks pass successfully.
...
## 💬 Reviews & Feedback
- **@steipete** (★★★★☆ 4/5): *Successfully implemented this for AWS Lambda. The verification step is extremely reliable.* (2026-05-02)