# The GitHub Actions Unit Test Coverage Verifies Loop

**Loop ID**: #4810 | **Category**: Engineering | **Author**: @victormustar | **Rating**: ⭐ 4.5/5.0
...
## 📝 Description
A repeatable agent workflow that verifies unit test coverage in GitHub Actions and stops when error rate drops below 0.1%.
...
## 💬 Reviews & Feedback
- **@swayam** (★★★★☆ 4/5): *Successfully implemented this for GitHub Actions. The verification step is extremely reliable.* (2026-03-19)