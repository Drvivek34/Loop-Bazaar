# The Elasticsearch Server Response Times Audits Loop

**Loop ID**: #4307 | **Category**: Engineering | **Author**: @victormustar | **Rating**: ⭐ 4.3/5.0
...
## 📝 Description
A repeatable agent workflow that audits server response times in Elasticsearch and stops when API response time is under 100ms.
...
## 🏷️ Keywords
elasticsearch, engineering, audits

## 💬 Reviews & Feedback
- **@victormustar** (★★★★☆ 4/5): *Successfully implemented this for Elasticsearch. The verification step is extremely reliable.* (2026-05-18)