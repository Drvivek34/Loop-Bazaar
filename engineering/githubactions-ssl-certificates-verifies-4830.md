# The GitHub Actions Ssl Certificates Verifies Loop

**Loop ID**: #4830 | **Category**: Engineering | **Author**: @inferencegod | **Rating**: ⭐ 4.5/5.0
...
## 📝 Description
A repeatable agent workflow that verifies SSL certificates in GitHub Actions and stops when error rate drops below 0.1%.
...
## 💬 Reviews & Feedback
- **@grace_hopper** (★★★★☆ 4/5): *Successfully implemented this for GitHub Actions. The verification step is extremely reliable.* (2026-03-05)