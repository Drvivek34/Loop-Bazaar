# The PostgreSQL Database Queries Profiles Loop

**Loop ID**: #3990 | **Category**: Engineering | **Author**: @richard_s | **Rating**: ⭐ 4.4/5.0
...
## 📝 Description
A repeatable agent workflow that profiles database queries in PostgreSQL and stops when stale state is fully cleared.
...
## 💬 Reviews & Feedback
- **@sophia_w** (★★★★☆ 4/5): *Successfully implemented this for PostgreSQL. The verification step is extremely reliable.* (2026-05-06)