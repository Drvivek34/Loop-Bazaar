# The Terraform Security Groups Standardizes Loop

**Loop ID**: #0882 | **Category**: Engineering | **Author**: @linus_t | **Rating**: ⭐ 4.9/5.0
...
## 📝 Description
A repeatable agent workflow that standardizes security groups in Terraform and stops when performance benchmark is met.
...
## 💬 Reviews & Feedback
- **@grace_hopper** (★★★★☆ 4/5): *Successfully implemented this for Terraform. The verification step is extremely reliable.* (2026-04-10)