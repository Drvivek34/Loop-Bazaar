# The GitHub Actions Cache Hit Ratios Verifies Loop

**Loop ID**: #3122 | **Category**: Engineering | **Author**: @marcus_a | **Rating**: ⭐ 4.2/5.0
...
## 📝 Description
A repeatable agent workflow that verifies cache hit ratios in GitHub Actions and stops when API response time is under 100ms.
...
## 💬 Reviews & Feedback
- **@matthewberman** (★★★★☆ 4/5): *Successfully implemented this for GitHub Actions. The verification step is extremely reliable.* (2026-03-26)