# The MongoDB Accessibility Tags Cleans up Loop

**Loop ID**: #2375 | **Category**: Engineering | **Author**: @matthewberman | **Rating**: ⭐ 4.5/5.0
...
## 📝 Description
A repeatable agent workflow that cleans up accessibility tags in MongoDB and stops when performance benchmark is met.
...
## 💬 Reviews & Feedback
- **@inferencegod** (★★★★☆ 4/5): *Successfully implemented this for MongoDB. The verification step is extremely reliable.* (2026-06-11)