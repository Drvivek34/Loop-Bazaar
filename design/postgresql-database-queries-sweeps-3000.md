# The PostgreSQL Database Queries Sweeps Loop

**Loop ID**: #3000 | **Category**: Design | **Author**: @sophia_w | **Rating**: ⭐ 4.6/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps database queries in PostgreSQL and stops when test coverage reaches 100%.
...
## 💬 Reviews & Feedback
- **@grace_hopper** (★★★★☆ 4/5): *Successfully implemented this for PostgreSQL. The verification step is extremely reliable.* (2026-03-27)