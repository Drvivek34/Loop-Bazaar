# The MongoDB Api Rate Limits Triages Loop

**Loop ID**: #0966 | **Category**: Design | **Author**: @matthewberman | **Rating**: ⭐ 4.5/5.0
...
## 📝 Description
A repeatable agent workflow that triages API rate limits in MongoDB and stops when API response time is under 100ms.
...
## 💬 Reviews & Feedback
- **@bjarnes** (★★★★☆ 4/5): *Successfully implemented this for MongoDB. The verification step is extremely reliable.* (2026-03-07)