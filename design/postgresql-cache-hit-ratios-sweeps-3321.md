# The PostgreSQL Cache Hit Ratios Sweeps Loop

**Loop ID**: #3321 | **Category**: Design | **Author**: @ken_t | **Rating**: ⭐ 4.3/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps cache hit ratios in PostgreSQL and stops when API response time is under 100ms.
...
## 💬 Reviews & Feedback
- **@ranvier2d2** (★★★★☆ 4/5): *Successfully implemented this for PostgreSQL. The verification step is extremely reliable.* (2026-01-17)