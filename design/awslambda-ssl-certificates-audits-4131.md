# The AWS Lambda Ssl Certificates Audits Loop

**Loop ID**: #4131 | **Category**: Design | **Author**: @bjarnes | **Rating**: ⭐ 4.2/5.0
...
## 📝 Description
A repeatable agent workflow that audits SSL certificates in AWS Lambda and stops when performance benchmark is met.
...
## 💬 Reviews & Feedback
- **@ken_t** (★★★★☆ 4/5): *Successfully implemented this for AWS Lambda. The verification step is extremely reliable.* (2026-04-17)