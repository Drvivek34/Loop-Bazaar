# The Terraform Bundle Sizes Refactors Loop

**Loop ID**: #0591 | **Category**: Design | **Author**: @dennis_r | **Rating**: ⭐ 4.9/5.0
...
## 📝 Description
A repeatable agent workflow that refactors bundle sizes in Terraform and stops when all vulnerabilities are resolved.
...
## 💬 Reviews & Feedback
- **@lucas_k** (★★★★☆ 4/5): *Successfully implemented this for Terraform. The verification step is extremely reliable.* (2026-05-26)