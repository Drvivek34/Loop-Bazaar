# The PostgreSQL Localized Files Profiles Loop

**Loop ID**: #2135 | **Category**: Design | **Author**: @inferencegod | **Rating**: ⭐ 4.0/5.0
...
## 📝 Description
A repeatable agent workflow that profiles localized files in PostgreSQL and stops when error rate drops below 0.1%.
...
## 💬 Reviews & Feedback
- **@ken_t** (★★★★☆ 4/5): *Successfully implemented this for PostgreSQL. The verification step is extremely reliable.* (2026-01-23)