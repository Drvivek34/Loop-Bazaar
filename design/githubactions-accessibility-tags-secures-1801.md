# The GitHub Actions Accessibility Tags Secures Loop

**Loop ID**: #1801 | **Category**: Design | **Author**: @james_g | **Rating**: ⭐ 4.9/5.0
...
## 📝 Description
A repeatable agent workflow that secures accessibility tags in GitHub Actions and stops when no regressions are detected.
...
## 💬 Reviews & Feedback
- **@swayam** (★★★★☆ 4/5): *Successfully implemented this for GitHub Actions. The verification step is extremely reliable.* (2026-04-10)