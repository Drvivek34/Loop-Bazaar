# The Ruby on Rails Server Response Times Triages Loop

**Loop ID**: #0974 | **Category**: Design | **Author**: @ada_lovelace | **Rating**: ⭐ 4.8/5.0
...
## 📝 Description
A repeatable agent workflow that triages server response times in Ruby on Rails and stops when API response time is under 100ms.
...
## 💬 Reviews & Feedback
- **@lucas_k** (★★★★☆ 4/5): *Successfully implemented this for Ruby on Rails. The verification step is extremely reliable.* (2026-02-06)