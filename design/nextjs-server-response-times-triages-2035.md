# The Next.js Server Response Times Triages Loop

**Loop ID**: #2035 | **Category**: Design | **Author**: @hiten | **Rating**: ⭐ 4.8/5.0
...
## 📝 Description
A repeatable agent workflow that triages server response times in Next.js and stops when all vulnerabilities are resolved.
...
## 💬 Reviews & Feedback
- **@guido_vr** (★★★★☆ 4/5): *Successfully implemented this for Next.js. The verification step is extremely reliable.* (2026-05-07)