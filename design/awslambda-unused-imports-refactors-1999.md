# The AWS Lambda Unused Imports Refactors Loop

**Loop ID**: #1999 | **Category**: Design | **Author**: @donald_k | **Rating**: ⭐ 4.7/5.0
...
## 📝 Description
A repeatable agent workflow that refactors unused imports in AWS Lambda and stops when stale state is fully cleared.
...
## 💬 Reviews & Feedback
- **@matthewberman** (★★★★☆ 4/5): *Successfully implemented this for AWS Lambda. The verification step is extremely reliable.* (2026-02-13)