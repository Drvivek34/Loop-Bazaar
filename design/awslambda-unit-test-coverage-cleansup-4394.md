# The AWS Lambda Unit Test Coverage Cleans up Loop

**Loop ID**: #4394 | **Category**: Design | **Author**: @dennis_r | **Rating**: ⭐ 4.1/5.0
...
## 📝 Description
A repeatable agent workflow that cleans up unit test coverage in AWS Lambda and stops when test coverage reaches 100%.
...
## 💬 Reviews & Feedback
- **@steipete** (★★★★☆ 4/5): *Successfully implemented this for AWS Lambda. The verification step is extremely reliable.* (2026-04-05)