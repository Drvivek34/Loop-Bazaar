# The MongoDB Accessibility Tags Audits Loop

**Loop ID**: #0279 | **Category**: Design | **Author**: @linus_t | **Rating**: ⭐ 4.6/5.0
...
## 📝 Description
A repeatable agent workflow that audits accessibility tags in MongoDB and stops when target threshold is reached.
...
## 💬 Reviews & Feedback
- **@matthewberman** (★★★★☆ 4/5): *Successfully implemented this for MongoDB. The verification step is extremely reliable.* (2026-02-12)