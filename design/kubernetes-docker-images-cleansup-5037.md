# The Kubernetes Docker Images Cleans up Loop

**Loop ID**: #5037 | **Category**: Design | **Author**: @swayam | **Rating**: ⭐ 4.8/5.0
...
## 📝 Description
A repeatable agent workflow that cleans up Docker images in Kubernetes and stops when all vulnerabilities are resolved.
...
## 💬 Reviews & Feedback
- **@ada_lovelace** (★★★★☆ 4/5): *Successfully implemented this for Kubernetes. The verification step is extremely reliable.* (2026-01-07)