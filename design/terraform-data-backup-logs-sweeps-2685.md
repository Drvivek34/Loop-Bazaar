# The Terraform Data Backup Logs Sweeps Loop

**Loop ID**: #2685 | **Category**: Design | **Author**: @inferencegod | **Rating**: ⭐ 4.6/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps data backup logs in Terraform and stops when test coverage reaches 100%.
...
## 🏷️ Keywords
terraform, design, sweeps

## 💬 Reviews & Feedback
- **@matthewberman** (★★★★☆ 4/5): *Successfully implemented this for Terraform. The verification step is extremely reliable.* (2026-03-22)