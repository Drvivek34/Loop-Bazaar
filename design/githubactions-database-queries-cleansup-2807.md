# The GitHub Actions Database Queries Cleans up Loop

**Loop ID**: #2807 | **Category**: Design | **Author**: @linus_t | **Rating**: ⭐ 4.5/5.0
...
## 📝 Description
A repeatable agent workflow that cleans up database queries in GitHub Actions and stops when performance benchmark is met.
...
## 💬 Reviews & Feedback
- **@grace_hopper** (★★★★☆ 4/5): *Successfully implemented this for GitHub Actions. The verification step is extremely reliable.* (2026-01-03)