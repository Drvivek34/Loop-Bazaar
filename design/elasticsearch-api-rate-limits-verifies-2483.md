# The Elasticsearch Api Rate Limits Verifies Loop

**Loop ID**: #2483 | **Category**: Design | **Author**: @Dis_Trackted | **Rating**: ⭐ 4.1/5.0
...
## 📝 Description
A repeatable agent workflow that verifies API rate limits in Elasticsearch and stops when stale state is fully cleared.
...
## 💬 Reviews & Feedback
- **@claudio_d** (★★★★☆ 4/5): *Successfully implemented this for Elasticsearch. The verification step is extremely reliable.* (2026-05-09)