# The PostgreSQL Memory Leaks Sweeps Loop

**Loop ID**: #4356 | **Category**: Design | **Author**: @richard_s | **Rating**: ⭐ 4.4/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps memory leaks in PostgreSQL and stops when API response time is under 100ms.
...
## 💬 Reviews & Feedback
- **@guido_vr** (★★★★☆ 4/5): *Successfully implemented this for PostgreSQL. The verification step is extremely reliable.* (2026-04-09)