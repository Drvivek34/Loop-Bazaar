# The Elasticsearch Api Rate Limits Cleans up Loop

**Loop ID**: #0723 | **Category**: Design | **Author**: @lSAAGl | **Rating**: ⭐ 4.8/5.0
...
## 📝 Description
A repeatable agent workflow that cleans up API rate limits in Elasticsearch and stops when target threshold is reached.
...
## 💬 Reviews & Feedback
- **@ranvier2d2** (★★★★☆ 4/5): *Successfully implemented this for Elasticsearch. The verification step is extremely reliable.* (2026-03-07)