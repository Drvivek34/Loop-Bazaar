# The Terraform Unit Test Coverage Validates Loop

**Loop ID**: #2480 | **Category**: Design | **Author**: @ranvier2d2 | **Rating**: ⭐ 4.3/5.0
...
## 📝 Description
A repeatable agent workflow that validates unit test coverage in Terraform and stops when no duplicate imports remain.
...
## 💬 Reviews & Feedback
- **@claudio_d** (★★★★☆ 4/5): *Successfully implemented this for Terraform. The verification step is extremely reliable.* (2026-02-04)