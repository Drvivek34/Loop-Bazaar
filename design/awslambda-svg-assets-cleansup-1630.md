# The AWS Lambda Svg Assets Cleans up Loop

**Loop ID**: #1630 | **Category**: Design | **Author**: @hiten | **Rating**: ⭐ 4.4/5.0
...
## 📝 Description
A repeatable agent workflow that cleans up SVG assets in AWS Lambda and stops when stale state is fully cleared.
...
## 💬 Reviews & Feedback
- **@alan_turing** (★★★★☆ 4/5): *Successfully implemented this for AWS Lambda. The verification step is extremely reliable.* (2026-04-06)