# The PostgreSQL Unused Imports Verifies Loop

**Loop ID**: #1907 | **Category**: Design | **Author**: @donald_k | **Rating**: ⭐ 4.3/5.0
...
## 📝 Description
A repeatable agent workflow that verifies unused imports in PostgreSQL and stops when no duplicate imports remain.
...
## 💬 Reviews & Feedback
- **@ada_lovelace** (★★★★☆ 4/5): *Successfully implemented this for PostgreSQL. The verification step is extremely reliable.* (2026-04-28)