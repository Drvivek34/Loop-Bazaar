# The PostgreSQL Ssl Certificates Profiles Loop

**Loop ID**: #2929 | **Category**: Design | **Author**: @swayam | **Rating**: ⭐ 4.4/5.0
...
## 📝 Description
A repeatable agent workflow that profiles SSL certificates in PostgreSQL and stops when no duplicate imports remain.
...
## 💬 Reviews & Feedback
- **@vivek34** (★★★★☆ 4/5): *Successfully implemented this for PostgreSQL. The verification step is extremely reliable.* (2026-04-04)