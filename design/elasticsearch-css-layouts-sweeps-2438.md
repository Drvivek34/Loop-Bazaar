# The Elasticsearch Css Layouts Sweeps Loop

**Loop ID**: #2438 | **Category**: Design | **Author**: @bjarnes | **Rating**: ⭐ 4.3/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps CSS layouts in Elasticsearch and stops when stale state is fully cleared.
