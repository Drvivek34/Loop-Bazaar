# The GitHub Actions Memory Leaks Cleans up Loop

**Loop ID**: #4240 | **Category**: Design | **Author**: @claudio_d | **Rating**: ⭐ 4.5/5.0
...
## 📝 Description
A repeatable agent workflow that cleans up memory leaks in GitHub Actions and stops when error rate drops below 0.1%.
