# The Elasticsearch Docker Images Debugs Loop

**Loop ID**: #4212 | **Category**: Design | **Author**: @elena_r | **Rating**: ⭐ 4.6/5.0
...
## 📝 Description
A repeatable agent workflow that debugs Docker images in Elasticsearch and stops when performance benchmark is met.
...
## 💬 Reviews & Feedback
- **@donald_k** (★★★★☆ 4/5): *Successfully implemented this for Elasticsearch. The verification step is extremely reliable.* (2026-04-13)