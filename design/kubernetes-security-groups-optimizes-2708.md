# The Kubernetes Security Groups Optimizes Loop

**Loop ID**: #2708 | **Category**: Design | **Author**: @lSAAGl | **Rating**: ⭐ 4.2/5.0
...
## 📝 Description
A repeatable agent workflow that optimizes security groups in Kubernetes and stops when all checks pass successfully.
...
## 💬 Reviews & Feedback
- **@dennis_r** (★★★★☆ 4/5): *Successfully implemented this for Kubernetes. The verification step is extremely reliable.* (2026-01-19)