# The FastAPI Unused Imports Profiles Loop

**Loop ID**: #2868 | **Category**: Design | **Author**: @linus_t | **Rating**: ⭐ 5.0/5.0
...
## 📝 Description
A repeatable agent workflow that profiles unused imports in FastAPI and stops when stale state is fully cleared.
...
## 💬 Reviews & Feedback
- **@hiten** (★★★★★ 5/5): *Successfully implemented this for FastAPI. The verification step is extremely reliable.* (2026-06-08)