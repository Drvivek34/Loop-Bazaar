# The Elasticsearch Access Control Lists Sweeps Loop

**Loop ID**: #3834 | **Category**: Design | **Author**: @matthewberman | **Rating**: ⭐ 4.1/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps access control lists in Elasticsearch and stops when no regressions are detected.
...
## 💬 Reviews & Feedback
- **@steipete** (★★★★☆ 4/5): *Successfully implemented this for Elasticsearch. The verification step is extremely reliable.* (2026-04-24)