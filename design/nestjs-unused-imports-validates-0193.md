# The NestJS Unused Imports Validates Loop

**Loop ID**: #0193 | **Category**: Design | **Author**: @linus_t | **Rating**: ⭐ 4.6/5.0
...
## 📝 Description
A repeatable agent workflow that validates unused imports in NestJS and stops when no duplicate imports remain.
