# The Elasticsearch Unused Imports Triages Loop

**Loop ID**: #0907 | **Category**: Design | **Author**: @swayam | **Rating**: ⭐ 4.6/5.0
...
## 📝 Description
A repeatable agent workflow that triages unused imports in Elasticsearch and stops when all checks pass successfully.
...
## 💬 Reviews & Feedback
- **@marcus_a** (★★★★☆ 4/5): *Successfully implemented this for Elasticsearch. The verification step is extremely reliable.* (2026-01-17)