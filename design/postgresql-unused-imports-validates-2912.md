# The PostgreSQL Unused Imports Validates Loop

**Loop ID**: #2912 | **Category**: Design | **Author**: @swayam | **Rating**: ⭐ 4.1/5.0
...
## 📝 Description
A repeatable agent workflow that validates unused imports in PostgreSQL and stops when stale state is fully cleared.
...
## 🏷️ Keywords
postgresql, design, validates

## 💬 Reviews & Feedback
- **@ken_t** (★★★★☆ 4/5): *Successfully implemented this for PostgreSQL. The verification step is extremely reliable.* (2026-04-04)