# The Elasticsearch Memory Leaks Standardizes Loop

**Loop ID**: #2987 | **Category**: Design | **Author**: @matthewberman | **Rating**: ⭐ 4.7/5.0
...
## 📝 Description
A repeatable agent workflow that standardizes memory leaks in Elasticsearch and stops when all checks pass successfully.
...
## 💬 Reviews & Feedback
- **@tim_berners** (★★★★☆ 4/5): *Successfully implemented this for Elasticsearch. The verification step is extremely reliable.* (2026-04-29)