# The GitHub Actions Svg Assets Validates Loop

**Loop ID**: #2910 | **Category**: Design | **Author**: @matthewberman | **Rating**: ⭐ 4.4/5.0
...
## 📝 Description
A repeatable agent workflow that validates SVG assets in GitHub Actions and stops when API response time is under 100ms.
...
## 💬 Reviews & Feedback
- **@ranvier2d2** (★★★★☆ 4/5): *Successfully implemented this for GitHub Actions. The verification step is extremely reliable.* (2026-05-29)