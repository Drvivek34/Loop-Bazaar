# The Flutter Unused Imports Sweeps Loop

**Loop ID**: #2396 | **Category**: Design | **Author**: @hiten | **Rating**: ⭐ 4.4/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps unused imports in Flutter and stops when performance benchmark is met.
...
## 💬 Reviews & Feedback
- **@richard_s** (★★★★☆ 4/5): *Successfully implemented this for Flutter. The verification step is extremely reliable.* (2026-05-04)