# The Kubernetes Unit Test Coverage Sweeps Loop

**Loop ID**: #3960 | **Category**: Design | **Author**: @donald_k | **Rating**: ⭐ 4.1/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps unit test coverage in Kubernetes and stops when error rate drops below 0.1%.
...
## 💬 Reviews & Feedback
- **@tim_berners** (★★★★☆ 4/5): *Successfully implemented this for Kubernetes. The verification step is extremely reliable.* (2026-05-12)