# The AWS Lambda Bundle Sizes Triages Loop

**Loop ID**: #2500 | **Category**: Design | **Author**: @swayam | **Rating**: ⭐ 4.4/5.0
...
## 📝 Description
A repeatable agent workflow that triages bundle sizes in AWS Lambda and stops when error rate drops below 0.1%.
...
## 🏷️ Keywords
aws lambda, design, triages

## 💬 Reviews & Feedback
- **@james_g** (★★★★☆ 4/5): *Successfully implemented this for AWS Lambda. The verification step is extremely reliable.* (2026-01-17)