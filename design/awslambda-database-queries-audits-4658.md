# The AWS Lambda Database Queries Audits Loop

**Loop ID**: #4658 | **Category**: Design | **Author**: @tim_berners | **Rating**: ⭐ 4.2/5.0
...
## 📝 Description
A repeatable agent workflow that audits database queries in AWS Lambda and stops when stale state is fully cleared.
...
## 💬 Reviews & Feedback
- **@donald_k** (★★★★☆ 4/5): *Successfully implemented this for AWS Lambda. The verification step is extremely reliable.* (2026-04-25)