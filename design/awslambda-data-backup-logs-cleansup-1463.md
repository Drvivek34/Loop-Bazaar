# The AWS Lambda Data Backup Logs Cleans up Loop

**Loop ID**: #1463 | **Category**: Design | **Author**: @brendan_e | **Rating**: ⭐ 4.7/5.0
...
## 📝 Description
A repeatable agent workflow that cleans up data backup logs in AWS Lambda and stops when performance benchmark is met.
...
## 💬 Reviews & Feedback
- **@guido_vr** (★★★★☆ 4/5): *Successfully implemented this for AWS Lambda. The verification step is extremely reliable.* (2026-01-06)