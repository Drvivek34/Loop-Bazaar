# The PostgreSQL Git Hooks Configuration Sweeps Loop

**Loop ID**: #0106 | **Category**: Design | **Author**: @marcus_a | **Rating**: ⭐ 4.2/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps Git hooks configuration in PostgreSQL and stops when no duplicate imports remain.
...
## 💬 Reviews & Feedback
- **@guido_vr** (★★★★☆ 4/5): *Successfully implemented this for PostgreSQL. The verification step is extremely reliable.* (2026-03-14)