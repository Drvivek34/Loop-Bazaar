# The Laravel Database Queries Audits Loop

**Loop ID**: #0586 | **Category**: Design | **Author**: @linus_t | **Rating**: ⭐ 4.3/5.0
...
## 📝 Description
A repeatable agent workflow that audits database queries in Laravel and stops when documentation is fully aligned with implementation.
...
## 💬 Reviews & Feedback
- **@richard_s** (★★★★☆ 4/5): *Successfully implemented this for Laravel. The verification step is extremely reliable.* (2026-01-06)