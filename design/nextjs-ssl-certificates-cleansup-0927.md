# The Next.js Ssl Certificates Cleans up Loop

**Loop ID**: #0927 | **Category**: Design | **Author**: @sophia_w | **Rating**: ⭐ 4.0/5.0
...
## 📝 Description
A repeatable agent workflow that cleans up SSL certificates in Next.js and stops when no duplicate imports remain.
...
## 💬 Reviews & Feedback
- **@inferencegod** (★★★★☆ 4/5): *Successfully implemented this for Next.js. The verification step is extremely reliable.* (2026-05-19)