# The GitHub Actions Database Queries Triages Loop

**Loop ID**: #4572 | **Category**: Design | **Author**: @matthewberman | **Rating**: ⭐ 4.7/5.0
...
## 📝 Description
A repeatable agent workflow that triages database queries in GitHub Actions and stops when all vulnerabilities are resolved.
...
## 🏷️ Keywords
github actions, design, triages

## 💬 Reviews & Feedback
- **@bjarnes** (★★★★☆ 4/5): *Successfully implemented this for GitHub Actions. The verification step is extremely reliable.* (2026-06-08)