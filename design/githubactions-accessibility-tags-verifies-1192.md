# The GitHub Actions Accessibility Tags Verifies Loop

**Loop ID**: #1192 | **Category**: Design | **Author**: @bjarnes | **Rating**: ⭐ 4.7/5.0
...
## 📝 Description
A repeatable agent workflow that verifies accessibility tags in GitHub Actions and stops when API response time is under 100ms.
...
## 💬 Reviews & Feedback
- **@matthewberman** (★★★★☆ 4/5): *Successfully implemented this for GitHub Actions. The verification step is extremely reliable.* (2026-02-04)