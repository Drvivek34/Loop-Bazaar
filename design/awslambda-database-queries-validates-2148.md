# The AWS Lambda Database Queries Validates Loop

**Loop ID**: #2148 | **Category**: Design | **Author**: @donald_k | **Rating**: ⭐ 4.3/5.0
...
## 📝 Description
A repeatable agent workflow that validates database queries in AWS Lambda and stops when stale state is fully cleared.
...
## 💬 Reviews & Feedback
- **@lucas_k** (★★★★☆ 4/5): *Successfully implemented this for AWS Lambda. The verification step is extremely reliable.* (2026-05-07)