# The Terraform Api Endpoints Profiles Loop

**Loop ID**: #2814 | **Category**: Design | **Author**: @vivek34 | **Rating**: ⭐ 4.1/5.0
...
## 📝 Description
A repeatable agent workflow that profiles API endpoints in Terraform and stops when no regressions are detected.
