# The Kubernetes Ssl Certificates Triages Loop

**Loop ID**: #2050 | **Category**: Design | **Author**: @0xUmbra | **Rating**: ⭐ 4.0/5.0
...
## 📝 Description
A repeatable agent workflow that triages SSL certificates in Kubernetes and stops when no duplicate imports remain.
...
## 💬 Reviews & Feedback
- **@0xUmbra** (★★★★☆ 4/5): *Successfully implemented this for Kubernetes. The verification step is extremely reliable.* (2026-01-29)