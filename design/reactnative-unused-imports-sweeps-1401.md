# The React Native Unused Imports Sweeps Loop

**Loop ID**: #1401 | **Category**: Design | **Author**: @inferencegod | **Rating**: ⭐ 4.7/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps unused imports in React Native and stops when all checks pass successfully.
...
## 💬 Reviews & Feedback
- **@lSAAGl** (★★★★☆ 4/5): *Successfully implemented this for React Native. The verification step is extremely reliable.* (2026-02-24)