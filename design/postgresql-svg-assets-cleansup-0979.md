# The PostgreSQL Svg Assets Cleans up Loop

**Loop ID**: #0979 | **Category**: Design | **Author**: @marcus_a | **Rating**: ⭐ 4.8/5.0
...
## 📝 Description
A repeatable agent workflow that cleans up SVG assets in PostgreSQL and stops when all checks pass successfully.
...
## 💬 Reviews & Feedback
- **@ken_t** (★★★★☆ 4/5): *Successfully implemented this for PostgreSQL. The verification step is extremely reliable.* (2026-06-12)