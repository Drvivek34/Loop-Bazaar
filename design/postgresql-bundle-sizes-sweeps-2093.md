# The PostgreSQL Bundle Sizes Sweeps Loop

**Loop ID**: #2093 | **Category**: Design | **Author**: @marcus_a | **Rating**: ⭐ 4.1/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps bundle sizes in PostgreSQL and stops when performance benchmark is met.
...
## 💬 Reviews & Feedback
- **@elena_r** (★★★★☆ 4/5): *Successfully implemented this for PostgreSQL. The verification step is extremely reliable.* (2026-04-17)