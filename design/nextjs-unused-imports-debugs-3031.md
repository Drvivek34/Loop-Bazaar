# The Next.js Unused Imports Debugs Loop

**Loop ID**: #3031 | **Category**: Design | **Author**: @bjarnes | **Rating**: ⭐ 4.9/5.0
...
## 📝 Description
A repeatable agent workflow that debugs unused imports in Next.js and stops when documentation is fully aligned with implementation.
...
## 🏷️ Keywords
next.js, design, debugs

## 💬 Reviews & Feedback
- **@guido_vr** (★★★★☆ 4/5): *Successfully implemented this for Next.js. The verification step is extremely reliable.* (2026-03-23)