# The React Native Memory Leaks Debugs Loop

**Loop ID**: #0445 | **Category**: Design | **Author**: @matthewberman | **Rating**: ⭐ 4.1/5.0
...
## 📝 Description
A repeatable agent workflow that debugs memory leaks in React Native and stops when target threshold is reached.
...
## 💬 Reviews & Feedback
- **@alan_turing** (★★★★☆ 4/5): *Successfully implemented this for React Native. The verification step is extremely reliable.* (2026-06-02)