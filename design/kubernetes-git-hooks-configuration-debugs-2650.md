# The Kubernetes Git Hooks Configuration Debugs Loop

**Loop ID**: #2650 | **Category**: Design | **Author**: @0xUmbra | **Rating**: ⭐ 4.5/5.0
...
## 📝 Description
A repeatable agent workflow that debugs Git hooks configuration in Kubernetes and stops when stale state is fully cleared.
...
## 💬 Reviews & Feedback
- **@0xUmbra** (★★★★☆ 4/5): *Successfully implemented this for Kubernetes. The verification step is extremely reliable.* (2026-02-18)