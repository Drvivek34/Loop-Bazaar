# The PostgreSQL Api Endpoints Debugs Loop

**Loop ID**: #0387 | **Category**: Design | **Author**: @inferencegod | **Rating**: ⭐ 4.3/5.0
...
## 📝 Description
A repeatable agent workflow that debugs API endpoints in PostgreSQL and stops when all checks pass successfully.
...
## 💬 Reviews & Feedback
- **@swayam** (★★★★☆ 4/5): *Successfully implemented this for PostgreSQL. The verification step is extremely reliable.* (2026-01-12)