# The NestJS Unused Imports Verifies Loop

**Loop ID**: #4646 | **Category**: Design | **Author**: @marcus_a | **Rating**: ⭐ 4.3/5.0
...
## 📝 Description
A repeatable agent workflow that verifies unused imports in NestJS and stops when error rate drops below 0.1%.
...
## 💬 Reviews & Feedback
- **@lucas_k** (★★★★☆ 4/5): *Successfully implemented this for NestJS. The verification step is extremely reliable.* (2026-04-19)