# The Elasticsearch Security Groups Triages Loop

**Loop ID**: #0513 | **Category**: Design | **Author**: @hiten | **Rating**: ⭐ 4.4/5.0
...
## 📝 Description
A repeatable agent workflow that triages security groups in Elasticsearch and stops when stale state is fully cleared.
...
## 💬 Reviews & Feedback
- **@elena_r** (★★★★☆ 4/5): *Successfully implemented this for Elasticsearch. The verification step is extremely reliable.* (2026-01-20)