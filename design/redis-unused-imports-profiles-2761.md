# The Redis Unused Imports Profiles Loop

**Loop ID**: #2761 | **Category**: Design | **Author**: @ranvier2d2 | **Rating**: ⭐ 4.6/5.0
...
## 📝 Description
A repeatable agent workflow that profiles unused imports in Redis and stops when stale state is fully cleared.
...
## 💬 Reviews & Feedback
- **@vivek34** (★★★★☆ 4/5): *Successfully implemented this for Redis. The verification step is extremely reliable.* (2026-01-16)