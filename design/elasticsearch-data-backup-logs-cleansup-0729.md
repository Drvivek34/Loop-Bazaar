# The Elasticsearch Data Backup Logs Cleans up Loop

**Loop ID**: #0729 | **Category**: Design | **Author**: @vivek34 | **Rating**: ⭐ 4.0/5.0
...
## 📝 Description
A repeatable agent workflow that cleans up data backup logs in Elasticsearch and stops when error rate drops below 0.1%.
...
## 💬 Reviews & Feedback
- **@elena_r** (★★★★☆ 4/5): *Successfully implemented this for Elasticsearch. The verification step is extremely reliable.* (2026-01-08)