# The Elasticsearch Localized Files Verifies Loop

**Loop ID**: #4125 | **Category**: Design | **Author**: @lSAAGl | **Rating**: ⭐ 4.0/5.0
...
## 📝 Description
A repeatable agent workflow that verifies localized files in Elasticsearch and stops when no duplicate imports remain.
...
## 💬 Reviews & Feedback
- **@claudio_d** (★★★★☆ 4/5): *Successfully implemented this for Elasticsearch. The verification step is extremely reliable.* (2026-05-05)