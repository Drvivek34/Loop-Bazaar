# The Elasticsearch Localized Files Debugs Loop

**Loop ID**: #4597 | **Category**: Design | **Author**: @agent0ai | **Rating**: ⭐ 4.7/5.0
...
## 📝 Description
A repeatable agent workflow that debugs localized files in Elasticsearch and stops when all checks pass successfully.
...
## 💬 Reviews & Feedback
- **@hiten** (★★★★☆ 4/5): *Successfully implemented this for Elasticsearch. The verification step is extremely reliable.* (2026-01-13)