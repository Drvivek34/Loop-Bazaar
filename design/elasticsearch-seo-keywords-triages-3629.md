# The Elasticsearch Seo Keywords Triages Loop

**Loop ID**: #3629 | **Category**: Design | **Author**: @agent0ai | **Rating**: ⭐ 4.9/5.0
...
## 📝 Description
A repeatable agent workflow that triages SEO keywords in Elasticsearch and stops when no duplicate imports remain.
...
## 💬 Reviews & Feedback
- **@tim_berners** (★★★★☆ 4/5): *Successfully implemented this for Elasticsearch. The verification step is extremely reliable.* (2026-02-21)