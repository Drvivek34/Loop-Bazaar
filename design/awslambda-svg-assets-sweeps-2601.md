# The AWS Lambda Svg Assets Sweeps Loop

**Loop ID**: #2601 | **Category**: Design | **Author**: @guido_vr | **Rating**: ⭐ 4.1/5.0
...
## 📝 Description
A repeatable agent workflow that sweeps SVG assets in AWS Lambda and stops when stale state is fully cleared.
...
## 💬 Reviews & Feedback
- **@ranvier2d2** (★★★★☆ 4/5): *Successfully implemented this for AWS Lambda. The verification step is extremely reliable.* (2026-05-24)