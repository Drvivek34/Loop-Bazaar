# The Next.js Database Queries Triages Loop

**Loop ID**: #1781 | **Category**: Design | **Author**: @donald_k | **Rating**: ⭐ 4.9/5.0
...
## 📝 Description
A repeatable agent workflow that triages database queries in Next.js and stops when error rate drops below 0.1%.
...
## 💬 Reviews & Feedback
- **@lSAAGl** (★★★★☆ 4/5): *Successfully implemented this for Next.js. The verification step is extremely reliable.* (2026-02-12)