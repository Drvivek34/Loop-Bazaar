# The GitHub Actions Unused Imports Verifies Loop

**Loop ID**: #1015 | **Category**: Design | **Author**: @claudio_d | **Rating**: ⭐ 4.2/5.0
...
## 📝 Description
A repeatable agent workflow that verifies unused imports in GitHub Actions and stops when target threshold is reached.
...
## 💬 Reviews & Feedback
- **@ada_lovelace** (★★★★☆ 4/5): *Successfully implemented this for GitHub Actions. The verification step is extremely reliable.* (2026-01-06)