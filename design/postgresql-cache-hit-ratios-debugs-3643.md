# The PostgreSQL Cache Hit Ratios Debugs Loop

**Loop ID**: #3643 | **Category**: Design | **Author**: @ranvier2d2 | **Rating**: ⭐ 4.2/5.0
...
## 📝 Description
A repeatable agent workflow that debugs cache hit ratios in PostgreSQL and stops when target threshold is reached.
...
## 💬 Reviews & Feedback
- **@vivek34** (★★★★☆ 4/5): *Successfully implemented this for PostgreSQL. The verification step is extremely reliable.* (2026-03-19)